...
class HelpCenterScreenShimmer extends StatelessWidget {
  const HelpCenterScreenShimmer({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const FractionallySizedBox(widthFactor: 0.42, child: ShimmerBox(height: 16)),
            SizedBox(height: height(14)),
            const ShimmerLines(count: 5, lineHeight: 12),
            SizedBox(height: height(18)),
            const FractionallySizedBox(widthFactor: 0.6, child: ShimmerBox(height: 16)),
            SizedBox(height: height(14)),
