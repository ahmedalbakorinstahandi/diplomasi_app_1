...
/// إشعار FCM أثناء التشغيل بنفس أسلوب [customSnackBar]؛ الضغط على المحتوى يستدعي [onOpen].
void customPushNotificationSnackBar({
  required String text,
  String message = '',
  required Future<void> Function() onOpen,
  Duration? duration,
}) {
  if (text.isEmpty && message.isEmpty) return;
  Get.closeAllSnackbars();
  ...
  const IconData glyph = Icons.notifications_rounded;
