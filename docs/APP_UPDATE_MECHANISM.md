...
هذا المستند يشرح كيف يتعامل تطبيق Flutter (`diplomasi_app`) مع استجابة **`app.force_update`** من الخادم، وكيف يُظهر **اقتراح تحديث** اختياريًا مع حد أقصى مرة واحدة كل 24 ساعة.
